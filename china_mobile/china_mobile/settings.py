...
# Scrapy settings for china_mobile project
#
...
BOT_NAME = 'china_mobile'

SPIDER_MODULES = ['china_mobile.spiders']
NEWSPIDER_MODULE = 'china_mobile.spiders'
...
#USER_AGENT = 'china_mobile (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'china_mobile.middlewares.ChinaMobileSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
DOWNLOADER_MIDDLEWARES = {
   'china_mobile.middlewares.RandomUserAgent': 543,
   'china_mobile.middlewares.RandomIpMiddleWare': 555,
}
...
ITEM_PIPELINES = {
        'china_mobile.pipelines.ChinaMobile': 300,
