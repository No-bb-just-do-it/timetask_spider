...
# Scrapy settings for sinochem project
#
...
SPIDER_MODULES = ['sinochem.spiders']
NEWSPIDER_MODULE = 'sinochem.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'sinochem (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'sinochem.middlewares.SinochemSpiderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'sinochem.pipelines.SinochemPipeline': 300,
}
