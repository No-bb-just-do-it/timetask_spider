...
# http://www.nanhai.gov.cn/cms/html/7849/column_7849_1.html @ 佛山市南海区人民政府网
class foshan_nanhaiSpiderSpider(scrapy.Spider):
    name = 'foshan_nanhai_gov_spider'
    ...
    def __init__(self):
        ...
        self.start_urls = {
            ...
            ('招标公告', 'http://www.nanhai.gov.cn/cms/sites/nanhai/zwgk_zdly_page_right.jsp?ColumnID=11960&page={}', 3)
        }
    ...
    def parse(self, response):
        ...
        infos = response.xpath('//div[@class="keyarea"]//tr')[1:-1]
    ...
    def parse_article(self, response):
        ...
        if '结果' in items['title'] or '成交' in items['title'] or items['title'] in '废标':
            items['type_id'] = '38257'
